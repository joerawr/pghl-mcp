...
// AA Divisions (season_id: number:9486)
const AA_DIVISIONS: Record<string, string> = {
  '12u AA': 'number:42897',
  '12u AAA': 'number:42898',  // Note: This is labeled AAA but in AA season
  '14u AA': 'number:42899',
  '16/19u AA': 'number:42900',
};

// Tier 1 / AAA Divisions (season_id: number:9485)
const TIER1_DIVISIONS: Record<string, string> = {
  '14u AAA': 'number:42895',
  '16/19u AAA': 'number:42896',
};
 ...
 * @returns Division ID (e.g., "number:42897")
 */
export function getDivisionId(division: string, seasonId: string): string {
  ...
  const divisionMap = seasonId === 'number:9485' ? TIER1_DIVISIONS : AA_DIVISIONS;
